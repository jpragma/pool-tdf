...
tdfApp.controller('tdfController', function ($scope) {
    ...
    var testData = [
        ...
        {t:[2,1.0],s:['5',0.91],a:['4 1/16',1.07],l:['1 1/2',0.98],r:0.95, id:'Gandy Big G'},
        {t:[3,0.95],s:['5',0.91],a:['3 7/8',1.1],l:['1 3/4',1.0],r:0.95, id:'A.E. Schmidt'},
        {t:[2,1.0],s:['4.4',1.0],a:['3.93',0.98],l:['1.19',0.95],r:0.93, id:'modified SAM'},
        {t:[2,1.0],s:['4 7/8',0.91],a:['4 1/8',1.02],l:['1 1/2',0.98],r:0.91, id:'GC home table'},
        {t:[2,1.0],s:['5 1/8',0.88],a:['4 1/8',1.05],l:['1 1/2',0.97],r:0.90, id:'GC iusedtoberich'},
